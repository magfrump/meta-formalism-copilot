...
export default function Home() {
  ...
  const causalGraph = useMemo(() => parseJson<CausalGraphResponse["causalGraph"]>(persistedCausalGraph), [persistedCausalGraph]);
  const statisticalModel = useMemo(() => parseJson<StatisticalModelResponse["statisticalModel"]>(persistedStatisticalModel), [persistedStatisticalModel]);
  const propertyTests = useMemo(() => parseJson<PropertyTestsResponse["propertyTests"]>(persistedPropertyTests), [persistedPropertyTests]);
  const dialecticalMap = useMemo(() => parseJson<DialecticalMapResponse["dialecticalMap"]>(persistedDialecticalMap), [persistedDialecticalMap]);
